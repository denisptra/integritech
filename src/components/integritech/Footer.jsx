  ...
  <footer className="border-t border-line bg-soft" aria-label="Footer">
    <div className="mx-auto max-w-site px-6 py-14 md:py-16">
              ...
              return (
                <li key={social.id}>
                  <a
                    ...
                    className="flex h-9 w-9 items-center justify-center rounded-md border border-line bg-white text-mist transition-colors duration-200 hover:border-navy hover:bg-navy hover:text-white"
                  >
      ...
      <div className="mt-12 flex flex-col gap-3 border-t border-line pt-7 sm:flex-row sm:items-center sm:justify-between">
        <p className="text-xs text-mist">© 2026 INTEGRITECH.id. All rights reserved.</p>
