      ...
      <div className="mx-auto max-w-site px-6 py-14 md:py-16">
        <div className="grid grid-cols-1 gap-10 md:grid-cols-12">
                ...
                return (
                  <li key={social.id}>
                    <a
                      ...
                      className="flex h-9 w-9 items-center justify-center rounded-full border border-line bg-white text-mist transition-colors duration-200 hover:border-navy hover:bg-navy hover:text-white"
                    >
          ...
          <nav className="md:col-span-3" aria-label="Navigasi footer">
            <h3 className="font-display text-[11px] font-bold uppercase tracking-[0.2em] text-ink">{t.studio}</h3>
          ...
          <div className="md:col-span-4">
            <h3 className="font-display text-[11px] font-bold uppercase tracking-[0.2em] text-ink">{t.contact}</h3>
            <ul className="mt-4 space-y-2.5">
              <li>
