...
export const BloomFeatures = ({ lang }) => {
      ...
      <div className="mx-auto max-w-site px-6">
        <Reveal>
          <div className="max-w-2xl">
            ...
            <h2 className="mt-5 font-display text-3xl font-extrabold tracking-tight text-ink leading-[1.12] md:text-5xl whitespace-pre-line">
              {t.servicesTitle}
            </h2>
          </div>
        </Reveal>
                ...
                <article className="group flex h-full flex-col overflow-hidden rounded-2xl border border-line bg-white transition-all duration-300 hover:-translate-y-1 hover:shadow-lift">
                  ...
                  <div className="flex flex-1 flex-col p-6">
                    <h3 className="font-display text-lg font-extrabold tracking-tight text-ink">
                      {lang === 'id' ? service.titleId : service.title}
                    </h3>
                    <p className="mt-3 flex-1 text-sm leading-relaxed text-mist">
                      {lang === 'id' ? service.descriptionId : service.description}
                    </p>
                  </div>
                </article>
              </Reveal>
