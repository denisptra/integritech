      ...
      <Reveal delay={220}>
        <div className="mt-9 flex flex-col items-center justify-center gap-3 sm:flex-row">
          <a
            ...
            className="group inline-flex w-full items-center justify-center gap-2 rounded-md bg-navy px-7 py-3.5 text-sm font-semibold text-white transition-colors duration-300 hover:bg-brand sm:w-auto"
          >
          ...
          <a
            ...
            className="inline-flex w-full items-center justify-center gap-2 rounded-md border border-line bg-white px-7 py-3.5 text-sm font-semibold text-ink transition-colors duration-300 hover:border-navy hover:text-navy sm:w-auto"
          >
